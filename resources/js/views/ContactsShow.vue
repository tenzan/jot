        ...
        <div v-else>
            <div class="flex justify-between">
                ...
                <div class="relative">
                    ...
                    <div v-if="modal" class="absolute bg-blue-900 text-white text-white rounded-lg z-20 p-8 w-64 right-0 mt-2 mr-6">
                        <p>Are you sure you want to delete this record?</p>

                        <div class="flex items-centered mt-6 justify-end">
